...
const Room = () => {
    ...
    return (
        <div>
            ...
            {myStream && <ReactPlayer url={myStream} height="200px" width="200px" playing muted />}
            {remoteStream && <ReactPlayer url={remoteStream} height="200px" width="200px" playing muted />}
        </div>
    )
}
export default Room;